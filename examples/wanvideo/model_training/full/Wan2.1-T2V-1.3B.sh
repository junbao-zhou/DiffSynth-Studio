...
accelerate launch  \
  ...
  --width 832 \
  --dataset_repeat 100 \
  --model_paths '["Wan-AI/Wan2.1-T2V-1.3B/diffusion_pytorch_model.safetensors","Wan-AI/Wan2.1-T2V-1.3B/models_t5_umt5-xxl-enc-bf16.pth","Wan-AI/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth"]' \
